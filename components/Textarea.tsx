...
const Textarea = forwardRef<HTMLTextAreaElement, {
    ...
    return (
      <textarea
        ...
        className={`w-full h-fit p-6 min-h-[60vh] max-h-none text-base leading-8 antialiased font-serif font-normal text-black focus:outline-none transition resize-none placeholder:text-muted caret-stone-900 ${className}`}
        style={{
